...
using GymErp.Domain.Subscriptions.Features.SuspendEnrollment;
...
try
{
    ...
    builder.Services
        ...
        .AddSingleton<PostgresTenantStringConnection>()
        .AddScoped<ITenantLocator, PostgresTenantLocatorStrategy>();
